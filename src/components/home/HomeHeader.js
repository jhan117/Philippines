...
const HomeHeader = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full px-6 py-4 flex justify-between items-center bg-slate-950 backdrop-blur-md border-b border-white/10 shadow-sm transition-all duration-300">
