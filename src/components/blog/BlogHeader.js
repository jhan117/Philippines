const BlogHeader = (props) => {
  ...
  return (
    <article className="flex flex-col gap-6 m-4 md:m-8 p-6 md:p-10 max-w-4xl mx-auto border border-slate-100 bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] [&_a]:text-blue-500 [&_a:hover]:underline [&_h3]:text-xl [&_h3]:font-bold [&_h3]:mt-6 [&_h3]:mb-3 [&_p]:leading-relaxed [&_p]:text-slate-700 [&_p]:mb-4">
