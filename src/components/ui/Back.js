...
import { faHouse, faArrowLeft, faArrowUp } from "@fortawesome/free-solid-svg-icons";
...
const Back = ({ children }) => {
  ...
  const isInterviewDetail = pathname.startsWith("/interview/") && pathname !== "/interview";
    ...
    <div>
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-3 z-50">
        ...
        <button
          ...
          aria-label={isInterviewDetail ? "인터뷰 목록으로 돌아가기" : "홈으로 이동"}
        >
          <FontAwesomeIcon 
